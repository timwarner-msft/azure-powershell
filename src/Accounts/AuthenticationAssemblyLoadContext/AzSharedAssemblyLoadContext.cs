...
{
    internal class AzSharedAssemblyLoadContext : CachedAssemblyLoadContext
    {
    ...
    internal abstract class CachedAssemblyLoadContext : AssemblyLoadContext
    {
        ...
        protected CachedAssemblyLoadContext(string name) : base(name) { }
